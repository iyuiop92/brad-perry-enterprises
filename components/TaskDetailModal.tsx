  ...
  return (
    <div className="flex-1 overflow-y-auto px-6 py-5 flex flex-col gap-5">
      ...
      <div className="flex flex-col flex-1">
        <p className="text-[10px] uppercase tracking-[0.2em] font-[600] mb-1.5" style={{ color: '#334155' }}>Notes</p>
        <textarea
          value={notes}
          ...
          style={{ background: '#04040a', border: '1px solid rgba(255,255,255,0.07)', color: '#94a3b8', minHeight: '140px' }}
        />
      </div>
      ...
      {/* Delete */}
      <button onClick={handleDelete} className="text-xs w-fit transition-colors" style={{ color: '#ef4444' }} onMouseEnter={e => (e.currentTarget.style.color = '#fca5a5')} onMouseLeave={e => (e.currentTarget.style.color = '#ef4444')}>
        Delete task
      </button>
    </div>
  )
